...
black: ## run black
	black --config pyproject.toml setup.py src/kiara_plugin/topic_modelling_dhbenelux tests

flake: ## check style with flake8
	flake8 src/kiara_plugin/topic_modelling_dhbenelux tests

mypy: ## run mypy
	mypy  --namespace-packages --explicit-package-base src/kiara_plugin/topic_modelling_dhbenelux
