[![PyPI status](https://img.shields.io/pypi/status/kiara_plugin.topic_modelling_dhbenelux.svg)](https://pypi.python.org/pypi/kiara_plugin.topic_modelling_dhbenelux/)
