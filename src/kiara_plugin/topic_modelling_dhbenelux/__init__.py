...
"""Top-level package for kiara_plugin.topic_modelling_dhbenelux."""
...
KIARA_METADATA = {
    ...
    "description": "Kiara modules for: topic-modelling-dhbenelux",
    "references": {
        "source_repo": {
        ...
        "documentation": {
            ...
            "url": "https://DHARPA-Project.github.io/kiara_plugin.topic_modelling_dhbenelux/",
        },
    },
    "tags": ["topic_modelling_dhbenelux"],
    "labels": {"package": "kiara_plugin.topic_modelling_dhbenelux"},
}

find_modules: KiaraEntryPointItem = (
    find_kiara_modules_under,
    "kiara_plugin.topic_modelling_dhbenelux.topic_modelling_dhbenelux",
)
find_model_classes: KiaraEntryPointItem = (
    find_kiara_model_classes_under,
    "kiara_plugin.topic_modelling_dhbenelux.models",
)
find_data_types: KiaraEntryPointItem = (
    find_data_types_under,
    "kiara_plugin.topic_modelling_dhbenelux.data_types",
)
find_pipelines: KiaraEntryPointItem = (
    find_pipeline_base_path_for_module,
    "kiara_plugin.topic_modelling_dhbenelux.pipelines",
    KIARA_METADATA,
)
